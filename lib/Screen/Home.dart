import 'package:academiaprototype/Screen/home_tab.dart';
import 'package:academiaprototype/Screen/home_widget.dart';
import 'package:academiaprototype/home_box.dart';
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            Radius.circular(5.0),
                        ...
                        child: Row(
                          ...
                          children: [
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Free Blink of the Day',  style: TextStyle(
                                  color: kPrimaryColor,
                                  fontSize: 19,
                                  fontWeight: FontWeight.bold,
                                ),),
                                Text('selected by our curators', style: TextStyle(
                                  color: kPrimaryColor,
                                  fontSize: 12,
                            ...
                            Icon(Icons.notifications_outlined, color: kPrimaryColor,),
                          ],
                        ),
                      ),
                      Home_Widget(),
                        ...
                        child: Row(
                          ...
                          children: [
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Work together any where', style: TextStyle(
                                    color: kPrimaryColor,
                                    fontSize: 14,
                                    fontWeight: FontWeight.bold,
                                  ),),
                                Text('Mr Sam and Prof Ay', style: TextStyle(
                                  color: kPrimaryColor,
                                  fontSize: 12,
                                  fontWeight: FontWeight.normal,
                                ),),
                            ...
                            Icon(Icons.share_outlined, color: kPrimaryColor, ),
                          ],
                        ),
                      ),
                      Text(
                          'A handBook on working Remotely - successfully - for Indiviuals, Teams and Managers', style: TextStyle(
                                  color: kPrimaryColor,
                                  fontSize: 12,
                                  fontWeight: FontWeight.normal,
                                ),),
                ...
                Text('Learning paths', style: kHeadingText2,),
                Text('Guilded learning on popular topics', style: kHeadingText3,),
